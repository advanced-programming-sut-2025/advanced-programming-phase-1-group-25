...
import org.example.Models.Player.Gift;
...
public class PlayerRelationController {
    ...
    public void talk(String username, String message) {
        ...
        relation.setXp(relation.getXp() + xpDelta);
    ...
    public void talkHistory(String username) {
        ...
        // prepare the output
        StringBuilder output = new StringBuilder();
        output.append(String.format("You talk history with %s:\n\n", targetPlayer.getName()));
