...
public class NPCController {
    ...
    public void meetNPC(String NPCName) {
        ...
        Relation relation = game.getRelation(currentPlayer, npc);
    ...
    public void giftNPC(String NPCName, String item) {
        ...
        // increase friendship points
        Relation relation = game.getRelation(player, npc);
    ...
    public void getQuestFromNPC(String NPCName) {
        ...
        StringBuilder output = new StringBuilder();
        output.append("New quest added successfully:\n");
        output.append(String.format("You should give %d %s to %s\n",
    ...
    public void questFinish(String numberStr) {
        ...
        this.view.showMessage(String.format("%s has given you %d %s.",
                npc.getName(), requestedAmount, rewardItemDefinition.getDisplayName()));;
    }
